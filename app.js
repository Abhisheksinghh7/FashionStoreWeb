 ...
 * 
 * This data element should be used in your Adobe Launch environment
 * to populate the commerce.productListItems field
 */
/*
...
products.forEach(function (item) {
  ...
  if (
    ...
    itemObj._digiwebanaoptznapactrsd = {
      caterpillarsigns: {
        productCategory: String(customData.productCategory || ""),
        productMaterial: String(customData.productMaterial || ""),
